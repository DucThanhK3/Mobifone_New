        ...
        <div class="modal-content">
            <form id="confirmForm" method="POST" action="{{ route('frontend.dangky') }}">
                ...
                <div class="modal-body">
                    <p>Bạn đang đăng ký gói cước <strong id="goi_ten"></strong> cho số điện thoại <strong>{{ $soDienThoai->so_dien_thoai }}</strong>.</p>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    confirmForm.addEventListener('submit', function (e) {
        ...
        const correctAnswer = parseFloat(mathAnswerInput.dataset.answer);
