...
{{-- ✅ Modal hiển thị chỉ số điện thoại --}}
<div id="confirmModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary">Nhập Số Điện Thoại</h5>
            ...
            <div class="modal-body">
                <form id="phoneForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" required placeholder="Nhập số điện thoại">
                    </div>
        ...
        buttons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                phoneForm.onsubmit = function (event) {
                    ...
                    // Kiểm tra số điện thoại Mobifone
                    if (phone.startsWith('090') || phone.startsWith('093') || phone.startsWith('091')) {
                        alert('Đăng ký thành công. Chờ admin duyệt.');
                        // Gửi yêu cầu duyệt cho admin (có thể thông qua Ajax hoặc Form)
                    } else {
